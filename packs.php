    ...
    <div class="container-fluid" id="cuerpo">
        ...
        <div class="row ml-5 pl-5">
            <div class="col-md-8">
                ...
                <p class="ppacks pb-2 pt-5">HOTELS</p>
                <div class="linia ">
                    <div class="row">
                ...
                <p class="ppacks pb-2 pt-5">ATTRACTIONS</p>
                <div class="linia">
                    <div class=" row">
                        <div class="col-md-3 pt-5">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <img src="img/atraccion1.png" alt="hotel1" class="img-responsive imagenes" id="h5">
                        </div>
                        <div class="col-md-3">
                            <img src="img/atraccion2.jpg" alt="hotel1" class="img-responsive imagenes" id="h6">
                        </div>
                        <div class="col-md-3">
                            <img src="img/atraccion3.jpg" alt="hotel1" class="img-responsive imagenes" id="h7">
                        </div>
                        <div class="col-md-3">
                            <img src="img/atraccion4.jpg" alt="hotel1" class="img-responsive imagenes" id="h8">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <p class="ppacks pb-2 pt-5">CREATE YOUR PACK</p>
